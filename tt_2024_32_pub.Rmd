...
---
I created this visualization using the data set shared by the TidyTuesday project for Week 32 of 2024. It includes data from 1896 to 2016 on participation in the Winter and Summer Olympic Games. I chose to look at medals won by Team USA from 1900 to 2009 by grouping by decade and calculating counts of medals.
...
```{r, echo=FALSE, include=FALSE, warning=FALSE}
#when/where did the United States win the most Gold/Silver/Bronze?
team_usa <- olympics %>%
  filter(noc == "USA") %>% 
  drop_na(medal) 
