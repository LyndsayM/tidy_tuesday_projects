...
p1 <- ggplot(
  ...
  geom_point(color = "#B58B00", fill = "#FEFBEA", shape = 21, show.legend = FALSE) 
...
p1
```
For this week's TidyTuesday I just wanted to have some fun. I created a scatter plot showing the average fat content by cheese type, and styled it to be reminiscent of a block of cheese. Then I created a word cloud showing the frequency of cheese by country.

My data exploration this week was a great reminder of how much of data visualization is data cleaning and shaping. To create these charts, I did a lot of recoding using case_when() and grepl(). 
